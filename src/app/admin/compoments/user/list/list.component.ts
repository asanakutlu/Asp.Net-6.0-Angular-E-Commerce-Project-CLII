...
export class ListComponent extends BaseComponent implements OnInit {
  ...
  async getUsers() {
    ...
    getAllUsers(this.paginator ? this.paginator.pageIndex : 0, this.paginator ? this.paginator.pageSize 
      : 5, () => this.hiddenSpinner(SpinnerType.BollAtom), errorMessage => this.alertifyService.message(errorMessage,
         {
      dismissOthers: true,
